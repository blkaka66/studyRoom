...
public interface ShopService extends BaseService<ShopEntity> {
   ...
   FinalResponseDto getMemberList(Long shopId);
...
//    List<ShopListResponseDto> getShopListResponseDto(Long shopId);
    ...
    FinalResponseDto signUp(ShopSignUpRequestDto dto); //회원가입

    //ShopInfoResponseDto getShopInfo(Long shopId);
    FinalResponseDto getShopInfo(Long shopId);
    ...
    FinalResponseDto getProductList(Long shopId ,String productType);//티켓 정보가져오기(시간권 기간권나눠서)
